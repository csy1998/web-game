...
socket.on('painting time',function (data) {
...
socket.on('guessing time',function (data) {
    data = JSON.parse(data);// name,word:,time
...
socket.on('update guessing time',function (data) {
    data = JSON.parse(data);
    info.player.innerText = data.name;
    info.time.innerText = data.time +'s';
    info.word.innerText = data.word;
...
socket.on('update painting time',function (data) {
    data = JSON.parse(data);
    info.time.innerText = data.time +'s';
});

socket.on('painting time out',function (id) {
...
socket.on('guessing time out',function (d) {
    d = JSON.parse(d);
